...
export default function PHPDevelopmentPage() {
  ...
  const services = [
    { icon: Code2, title: "Custom PHP Development", desc: "Scalable and secure PHP web applications built from scratch." },
    { icon: Server, title: "Backend Development", desc: "Strong server-side architecture for high-performance apps." },
    { icon: Database, title: "Database Design", desc: "Optimized MySQL/PostgreSQL database architecture." },
    { icon: Globe, title: "Web Application Development", desc: "Dynamic and interactive business web platforms." },
    { icon: Layers, title: "CMS Development", desc: "WordPress, custom CMS & enterprise content systems." },
    { icon: Shield, title: "Security & Hardening", desc: "Advanced protection from SQL injection & attacks." },
    { icon: Zap, title: "Performance Optimization", desc: "Faster load time and optimized backend performance." },
    { icon: Cloud, title: "Cloud Deployment", desc: "Deploy PHP apps on AWS, Azure, and modern servers." },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-cyan-50 text-slate-900">
      ...
      <section className="px-4 sm:px-6 py-24 md:py-32 text-center max-w-5xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/70 border backdrop-blur-xl shadow">
          <Code2 size={16} /> PHP Development Services
        </div>
        ...
        <p className="mt-6 text-slate-600 max-w-2xl mx-auto">
          We build fast, secure, and scalable PHP-based web applications using modern frameworks
          like Laravel, CodeIgniter, and Symfony for startups and enterprises.
        </p>
      ...
      <section className="px-4 sm:px-6 py-24">
        <div className="max-w-5xl mx-auto text-center bg-white/60 backdrop-blur-3xl border rounded-[40px] p-10 shadow-2xl">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">
            Need a Scalable PHP Solution?
          </h2>

          <p className="mt-4 text-slate-600">
            Let’s build a secure, fast, and modern PHP application for your business.
          </p>
