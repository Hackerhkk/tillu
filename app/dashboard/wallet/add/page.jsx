      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">Manage your balance & transactions</p>
          </div>
        </div>

        {/* BALANCE CARD */}
        <div className="bg-white/60 backdrop-blur-2xl border border-white/70 rounded-3xl shadow-xl p-8 mb-8">
          <p className="text-slate-500">Available Balance</p>
          <h2 className="text-4xl font-bold mt-2">₹ {balance}</h2>

          <div className="flex gap-3 mt-6">
            <button className="flex items-center gap-2 bg-cyan-600 text-white px-4 py-2 rounded-xl hover:scale-105 transition">
              <Plus size={16} />
              Add Money
            </button>

            <button className="flex items-center gap-2 bg-black text-white px-4 py-2 rounded-xl hover:scale-105 transition">
        ...
        <div className="bg-white/60 backdrop-blur-2xl border rounded-3xl shadow-xl p-6 mb-8">
          ...
          <div className="flex gap-3">
            ...
            <button className="bg-cyan-600 text-white px-6 rounded-xl hover:scale-105 transition">
              Add
            </button>
          </div>
        </div>
        ...
        <div className="bg-white/60 backdrop-blur-2xl border rounded-3xl shadow-xl p-6">
          ...
          <div className="space-y-3">
            ...
            {[
              { type: "credit", amount: 500, text: "Added Money" },
              { type: "debit", amount: 200, text: "Withdraw" },
              { type: "credit", amount: 1000, text: "Refund" },
            ].map((tx, i) => (
              <div
                key={i}
